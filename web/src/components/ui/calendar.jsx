  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: "flex justify-center pt-2 pb-2 relative items-center px-3",
        caption_label: "text-sm font-medium",
        nav: "absolute flex items-center justify-between top-1 left-0 right-0 h-9",
        ...
        day: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-full [&:has([aria-selected].day-range-start)]:rounded-l-full first:[&:has([aria-selected])]:rounded-l-full last:[&:has([aria-selected])]:rounded-r-full [&[aria-selected]>button:hover]:bg-transparent focus-within:relative focus-within:z-20",
        ...
        range_middle:
          "aria-selected:bg-violet-100 dark:aria-selected:bg-violet-400/20 aria-selected:text-white dark:aria-selected:text-white aria-selected:rounded-none aria-selected:hover:bg-violet-100 dark:aria-selected:hover:bg-violet-400/20",
        hidden: "invisible",
        ...classNames,
      }}
      components={{
